...
wget -P ~/.config/clash https://gitee.com/chukk8/linux-clash/blob/master/Country.mmdb
...
```
rm -rf /usr/bin/clash 
wget -P /usr/bin/ https://gitee.com/chukk8/linux-clash/blob/master/clash
...
```
下载地址：
wget https://gitee.com/chukk8/linux-clash/blob/master/clash
```
